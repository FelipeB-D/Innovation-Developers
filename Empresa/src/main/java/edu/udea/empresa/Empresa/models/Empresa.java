...
public class Empresa {
    ...
    public Empresa(int idEmpresa, String nombreEmpresa, String documentoEmpresa, String telefonoEmpresa, String direccionEmpresa, Date fechaCreacionEmpresa, Date fechaActualizacionEmpresa, List<Empleado> empleados, List<Transaccion> transacciones) {
